...
def transitions(current_method, N_H, N_P, Mh, Mp, w_H, w_P):
    ...
    if current_method in ['local_update', 'moran', 'gillespie_local_update', 'gillespie_moran']:
        ...
        elif current_method in ['local_update', 'gillespie_local_update']:
        ...
        if current_method in ['local_update', 'moran']:  
        ...
        elif current_method in ['gillespie_local_update', 'gillespie_moran']:  
        ...
        return 'nan'
##########################################################################################################################################################
def current_transitions_4d_song(n_h, n_h2, n_p, n_p2, w_H, w_P, alpha, beta):
...
def current_transitions_4d_LV(n_h, n_h2, n_p, n_p2, birth_H_LV, death_P_LV, mu, lam):
...
def update(current_method, current_probabilities):
    ...
    if current_method in ['moran', 'local_update']:
    ...
    elif current_method in ['gillespie_moran', 'gillespie_local_update']:
